                ...
                <div class="form_list_hdld">
                    <div class="form_list_item_htld">
                        ...
                        <div class="form_add_hdld">
                            ...
                            <input type="text" name="" id="loai_hd" class="form_input_add_htld">
                        </div>
                        <div class="form_add_hdld">
                            <label for="" class="form_title_htld">Ngày ký</label> <br>
                            <input type="date" name="" id="ngay_ky" class="form_input_add_htld">
                        </div>
                        <div class="form_add_hdld">
                            <label for="" class="form_title_htld">Ngày bắt đầu</label> <br>
                            <input type="date" name="" id="ngay_bat_dau" class="form_input_add_htld">
                        </div>
                        <div class="form_add_hdld">
                            <label for="" class="form_title_htld">Ngày kết thúc</label> <br>
                            <input type="date" name="" id="ngay_ket_thuc" class="form_input_add_htld">
                        </div>
                    </div>
                    <div class="form_list_item_htld">
                        <div class="form_add_hdld">
                            <label for="" class="form_title_htld">Địa điểm làm việc</label> <br>
                            <input type="text" name="" id="dia_diem" class="form_input_add_htld">
                        </div>
                        <div class="form_add_hdld">
                            <label for="" class="form_title_htld">Chuyên môn</label> <br>
                            <input type="text" name="" id="chuyen_mon" class="form_input_add_htld">
                        </div>
                        <div class="form_add_hdld">
                            <label for="" class="form_title_htld">Pháp nhân</label> <br>
                            <input type="text" name="" id="phap_nhan" class="form_input_add_htld">
                        </div>
                        <div class="form_add_hdld">
                            <label for="" class="form_title_htld">Lương cơ bản</label> <br>
                            <input type="text" name="" id="luong" class="form_input_add_htld">
                        </div>
                        <div class="form_add_hdld">
                            <label for="" class="form_title_htld">Hệ số lương</label> <br>
                            <input type="text" name="" id="heso" class="form_input_add_htld">
                        </div>
                    </div>
                </div>

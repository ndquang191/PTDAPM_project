                    ...
                    <div class="form_list_danhgia">
                        <div class="form_list_item_danhgia">
                            <div class="form_add_danhgia">
                                ...
                                <input type="text" name="" style="background-color: #fff;" id="id" class="form-control form_input_add_danhgia" readonly>
                            </div>
                            <div class="form_add_danhgia">
                            ...
                            <div class="form_add_danhgia">
                                ...
                                <input type="text" name="" id="noidung" class="form-control form_input_add_danhgia">
                            </div>
                        </div>
                        <div class="form_list_item_danhgia">
                            <div class="form_add_danhgia">
                                <label for="" class="form_title_danhgia">Tên nhân viên</label> <br>
                                <input type="text" name="" style="background-color: #fff;" id="ten_nv" class="form-control form_input_add_danhgia" readonly>
                            </div>
                            <div class="form_add_danhgia">
                                <label for="" class="form_title_danhgia">Ngày quyết định</label> <br>
                                <input type="text" name="" id="ngay_quyet_dinh" class="form-control form_input_add_danhgia">
                            </div>
                            <div class="form_add_danhgia">
                                <label for="" class="form_title_danhgia">Giá trị</label> <br>
                                <input type="text" name="" id="giatri" class="form-control form_input_add_danhgia">
                            </div>
                        </div>
                    </div>
